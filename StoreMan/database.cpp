...
void DataBase::createTables() {
    ...
    query.exec("CREATE TABLE orders (id_order INTEGER PRIMARY KEY AUTOINCREMENT, ids_product JSON NOT NULL, quantity JSON NOT NULL, prices JSON NOT NULL, discounted_prices JSON NOT NULL, discount_rate INTEGER NOT NULL, order_date TEXT NOT NULL, id_customer INTEGER NOT NULL, FOREIGN KEY (id_customer) REFERENCES customer(id_customer))");
